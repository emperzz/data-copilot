...
| **Built-in** | `present_files`, `ask_clarification`, `sql_check_syntax`, `sql_extract_metadata`, `sql_transpile`, `view_image`, `task` (subagent); `tool_search` when deferred MCP loading is on |
